...
export const Vis = () => {
    ...
    let select = document.getElementById("varSelect");
    ...
    let selectQuantity = document.getElementById("valQuantity");
    ...
    function updateEmphVar(e) {
      ...
      newEmphasis.updateVariable(e.target.value);
    ...
    function updateEmphVal(e) {
      ...
      newEmphasis.updateVal(e.target.value);
      let newAugs = newEmphasis.getAugs();
      draft.augment(newAugs);
    }
}
